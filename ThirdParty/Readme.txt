Run CallingCmake_opencv.cmd at first.
And then run CallingCmake_dlib.cmd.
...
To avoid errors related to CRT, I set opencv's BUILD_SHARED_LIBS to OFF, and I replaced "/MD" with "/MT" in CMAKE_{C|CXX}_FLAGS*.
WITH_IPP=OFF also seems to be necessary to build apps with dlib.
