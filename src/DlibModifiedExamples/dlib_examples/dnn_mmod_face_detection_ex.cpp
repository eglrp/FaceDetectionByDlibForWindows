...
void dnn_mmod_face_detection_ex_test() try
{
	int argc = 1;
	char* argv[100];
	...
	argv[argc++] = "c:/TempData/01.png";
	argv[argc++] = "c:/TempData/02.png";
	...
	for (int i = 2; i < argc; ++i)
	{
		...
		{
			// In the above example images, it needs to call pyramid_up at least once.
			pyramid_up(img);
		}
